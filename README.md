...
🎨 Image Generation — type a text description and watch AI draw it for you
👁️ Image Understanding — give AI a photo and ask it anything about it
💬 Chat Generation — build a chatbot that remembers your conversation

What participants will learn:

What Gemini and Imagen are and how they work
How Vertex AI connects your code to Google's AI models
What an API and Client are and why they matter
How to write and run Python code in Google Colab
How to modify AI prompts to get different results
